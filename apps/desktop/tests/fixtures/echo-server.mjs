 ...
 *
 * It exists so the Desktop bundle tests carry a real server inside the archives
 * they install, rather than a placeholder that only has to exist.
 *
    ...
    if (request.method === 'initialize') {
      write({
        ...
        result: {
          ...
          capabilities: { tools: {} },
          serverInfo: { name: 'desktop-bundle-fixture', version: '1.0.0' },
        },
      })
      continue
    }
